...
## [1.0.2](https://github.com/pokujs/dom/compare/v1.0.1...v1.0.2) (2026-04-05)


### Bug Fixes

* preserve `node:` builtin import specifiers in the published ESM output so Deno can load `@pokujs/dom` successfully
